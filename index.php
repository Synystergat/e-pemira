						...
						<div class="wrap-login100">
							...
							<form class="login100-form validate-form" action="" method="post">
								...
								<div class="wrap-input100 validate-input">
									<input class="input100" type="text" name="nim" placeholder="Masukan nomor urut..." autocomplete="off" required="required">
								...
								<div class="text-center p-t-12">
									...
									<a class="txt2" href="#">
										<p>&copy;Copyright Himpunan Mahasiswa Akuntansi <?php echo date('Y') ?></p>
									</a>
								</div>
