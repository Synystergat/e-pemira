        ...
        <div class="col-lg-6">
          <form action="" method="post" enctype="multipart/form-data">
            <div class="form-group">
              <label>NIM Calon Ketua Himpunan</label>
              <input type="text" name="nim_ketua" required="required" class="form-control">
            </div>
            <div class="form-group">
              <label>Nama Calon Ketua Himpunan</label>
            ...
            <div class="form-group">
              <label>NIM wakil Ketua Himpunan</label>
              <input type="text" name="nim_wakil" required="required" class="form-control">
            </div>
            <div class="form-group">
              <label>Nama wakil Himpunan</label>
...
<div class="footer">
  <div class="row">
    <div class="col-lg-12" >
      &copy; Copyright Himpunan Mahasiswa Akuntansi  <?php echo date('Y') ?> <a href="http://binarytheme.com" style="color:#fff;" target="_blank"></a>
    </div>
  </div>
</div>
