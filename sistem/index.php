...
if(isset($_POST['simpan'])) {
        ...
        <div class="row">
          <div class="col-lg-12 ">
            <div class="alert alert-danger" style="text-align: center;">
              <strong>Suara Anda Menentukan Masa Depan HiMA PSDKU Pekalongan,Jadi Bijaklah Ketika Memilih !!! </strong> 
            </div>
          </div>
        </div>
        <!-- /. ROW  --> 
  ...
  <div class="footer">
    <div class="row">
      <div class="col-lg-12" >
        &copy; Himpunan Mahasiswa Akuntansi <?php echo date('Y') ?> <a href="http://binarytheme.com" style="color:#fff;" target="_blank"></a>
      </div>
    </div>
  </div>
